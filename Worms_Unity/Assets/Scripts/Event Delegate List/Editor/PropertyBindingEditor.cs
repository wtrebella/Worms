...
public class PropertyBindingEditor : Editor
{
	public override void OnInspectorGUI ()
	{
		...
		EventDelegateEditorTools.SetLabelWidth(80f);
		...
		EventDelegateEditorTools.DrawProperty(serializedObject, "source");
		...
		EventDelegateEditorTools.DrawProperty(serializedObject, "target");
		...
		GUILayout.Space(1f);
		EventDelegateEditorTools.DrawPaddedProperty(serializedObject, "direction");
		EventDelegateEditorTools.DrawPaddedProperty(serializedObject, "update");
		GUILayout.BeginHorizontal();
		EventDelegateEditorTools.DrawProperty(" ", serializedObject, "editMode", GUILayout.Width(100f));
